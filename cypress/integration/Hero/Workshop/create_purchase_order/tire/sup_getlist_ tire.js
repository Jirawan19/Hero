...
const purchase_order = () => {
    ...
    // +vat 7%
    cy.get('div[style="cursor: pointer;"] > .three').contains("28,050.00")
    cy.get('.total-price').contains("28,050.00")
    ...
    cy.get('#priceTotaltd').contains("28,050.00")
    cy.get('#totalNettd').contains("28,050.00")
...
const supplier_getLish = () => {
    ...
    cy.get(':nth-child(1) > .text-right').contains("28,050.00")
    cy.get('tfoot > :nth-child(4) > .text-right').contains("28,050.00")
...
const check_finance = () => {
    ...
    cy.get(':nth-child(2) > .text-right').contains("28,050.00")
}